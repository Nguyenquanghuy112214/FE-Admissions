...
import styles from './_TCKQPage.module.scss';
          ...
          <Col xxl={6} xl={6} lg={7} md={8}>
            ...
            >
              {(formikProps) => {
                ...
                return (
                  <Form>
                    <div className={cx('wrapper')}>NHẬP THÔNG TIN TRA CỨU</div>
                    {/* Start chon cấp học */}
                    <div>
                    ...
                    <div>
                      {errors.identifier && touched.identifier ? (
                        ...
                        <span className={cx('text-user')}>
                          {' '}
                          <p style={{ color: 'red', display: 'inline-block', marginRight: '6px', fontWeight: 'bold' }}>*</p>Mã định danh
                        </span>
                      )}
                      <Input
